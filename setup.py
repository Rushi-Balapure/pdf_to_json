...
def read_readme():
    ...
    if os.path.exists(readme_path):
        with open(readme_path, "r", encoding="utf-8") as f:
            return f.read()
    return "PDF2JSON - A high-performance PDF to JSON extraction library"
...
setup(
    ...
    entry_points={
        "console_scripts": [
            "pdf2json=pdf2json.cli:main",
        ],
    },
    keywords="pdf json extraction text processing layout analysis",
    project_urls={
        "Bug Reports": "https://github.com/your-username/pdf2json/issues",
        "Source": "https://github.com/your-username/pdf2json",
        "Documentation": "https://github.com/your-username/pdf2json#readme",
    },
)
